...
obj_type cube = 
{
    ...
    // correct texture mapping
    {
        ...
        0.0, 0.0,  // mapping coordinates for vertex v2
        1.0, 0.0,  // mapping coordinates for vertex v3

        0.0, 0.0,  // mapping coordinates for vertex v4
        1.0, 0.0,  // mapping coordinates for vertex v5
        0.0, 1.0,  // mapping coordinates for vertex v6 
...
void  init(void)
{
    ...
    cube.id_texture=LoadBitmap("background.bmp"); // The Function LoadBitmap() return the current texture ID
