...
double distance_x = 0, distance_x_increment = 3;
...
void keyboard_s (int key, int x, int y)
{
    ...
    {
        case GLUT_KEY_UP:
            distance_z -= distance_z_increment;
        break;
        case GLUT_KEY_DOWN:
            distance_z += distance_z_increment;
        break;
...
void display(void)
{
    ...
    glTranslatef(distance_x,0.0,distance_z); // We move the object forward (the model matrix is multiplied by the translation matrix)
   ...
   // rotation_y = rotation_y + rotation_y_increment;
    ...
    glRotatef(90,1.0,0.0,0.0); // Rotations of the object (the model matrix is multiplied by the rotation matrices)
